  ...
  return (
    <div className="home">
      <div class="container">
            ...
            <br></br>
              <div class="container" style={{textAlign: 'center', width: "65%"}}>
                ...
                <br></br>
                <br></br>
                Although we are currently limited to e-commerce, eventually as crypto adoption increases, we will also print the SBT addresses as crypto-barcodes on products to enable on-chain transactions to be executed for in-store commerce as well.
                <br></br>
                <br></br>
                ...
                <i>Please refer to our GitHub or Twitter for more details; any and all feedback is welcome.
                <br></br>
                <br></br>
